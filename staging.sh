...
APP_FOLDER="prime-laravel-template" 
BRANCH="dev-staging"
...
sed -i "s|/../vendor|/../$APP_FOLDER/vendor|g" "$PUBLIC_DIR/index.php"
sed -i "s|/../bootstrap|/../$APP_FOLDER/bootstrap|g" "$PUBLIC_DIR/index.php"
sed -i "s|/../storage|/../$APP_FOLDER/storage|g" "$PUBLIC_DIR/index.php"
